...
pretrained_settings = {
    'senet154': {
        'imagenet': {
            'checkpoint': f'{checkpoint_dir}/senet154-c7b49a05.pth',
            'input_space': 'RGB',
    ...
    'se_resnet50': {
        'imagenet': {
            'checkpoint': f'{checkpoint_dir}/se_resnet50-ce0d4300.pth',
            'input_space': 'RGB',
            'input_size': [3, 224, 224],
            'input_range': [0, 1],
            'mean': [0.485, 0.456, 0.406],
    ...
    'se_resnet101': {
        'imagenet': {
            'checkpoint': f'{checkpoint_dir}/se_resnet101-7e38fcc6.pth',
            'input_space': 'RGB',
            'input_size': [3, 224, 224],
            'input_range': [0, 1],
            'mean': [0.485, 0.456, 0.406],
    ...
    'se_resnet152': {
        'imagenet': {
            'checkpoint': f'{checkpoint_dir}/se_resnet152-d17c99b7.pth',
            'input_space': 'RGB',
            'input_size': [3, 224, 224],
            'input_range': [0, 1],
            'mean': [0.485, 0.456, 0.406],
    ...
    'se_resnext50_32x4d': {
        'imagenet': {
            'checkpoint': f'{checkpoint_dir}/se_resnext50_32x4d-a260b3a4.pth',
            'input_space': 'RGB',
            'input_size': [3, 224, 224],
            'input_range': [0, 1],
            'mean': [0.485, 0.456, 0.406],
    ...
    'se_resnext101_32x4d': {
        'imagenet': {
            'checkpoint': f'{checkpoint_dir}/se_resnext101_32x4d-3b2fe3d8.pth',
            'input_space': 'RGB',
            'input_size': [3, 224, 224],
            'input_range': [0, 1],
            'mean': [0.485, 0.456, 0.406],
...
def initialize_pretrained_model(model, num_classes, settings):
    ...
    checkpoint = torch.load(settings['checkpoint'], weights_only=True)
